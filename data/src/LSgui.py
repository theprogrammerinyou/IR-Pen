...
from LStrack_working import start
...
# /Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.pnglightscreen-touchscreen-detection/data/sound/drawing.mp3

def mainWin():
    # font.add_file("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.pnglightscreen-touchscreen-detection/data/src/RobotoMono-Light.ttf")
    # version = "v1.0"
    ...
    # icon = "/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.pnglightscreen-touchscreen-detection/data/images/winIcon.ico"
    # if system() == "Linux":
    #     icon = "@/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.pnglightscreen-touchscreen-detection/data/images/linuxIcon.xbm" 
    ...
    #     "c": "#202020"
    #     }
    # imglocation = "/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.pnglightscreen-touchscreen-detection/data/images/spandark.png"
    # mainimg = Image.open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.pnglightscreen-touchscreen-detection/data/images/maindark.png")
    ...
    #     color["t"] = "#665ab5"
    #     color["c"] = "#857a87"
    #     imglocation = "/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.pnglightscreen-touchscreen-detection/data/images/spanlight.png"
    #     mainimg = Image.open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.pnglightscreen-touchscreen-detection/data/images/mainlight.png")
    #     mainimage = ImageTk.PhotoImage(mainimg)
    
    # # opens image in correct format
    # spanimg = Image.open(imglocation)
    # resized = spanimg.resize((360, 72), Image.Resampling.LANCZOS)
...
def validateFiles():
    ...
    with open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/settings.txt", "r") as f:  # reads files contents
    ...
    with open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/profile.txt", "r") as f:  # validates profile
        contents = f.readlines()
        if len(contents) != 2:
            validProfile = False
        for entry in contents:
    ...
    if not validProfile:  
        with open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/profile.txt", "w") as f:
            f.write("points: \nmaskparams: ")
    if not validSettings:
       with open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/settings.txt", "w") as f:
           f.write(default)

    with open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/settings.txt", "r") as f:
        config = f.readlines()
...
def viewSettings(main, color, config, default):
    ...
    img = Image.open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/save.png")
    resize = img.resize((125,50), Image.Resampling.LANCZOS)
    ...
    img2 = Image.open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/images/default.png")
    resize2 = img2.resize((125,50), Image.Resampling.LANCZOS)
...
def onSave(btn, darkMode, startup, minTray, wvar, hvar):
    ...
    with open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/settings.txt", "w") as f:  # writes selected and inputted values to file
        f.write(toSave) 
...
def startTracking(root):  # starts tracking
    ...
    with open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/profile.txt", "r") as f:  # obtain profile (calibration) contents
        contents = f.readlines()
    ...
    try:
        for entry in contents:
            ...
            if key == "points":
                ...
                maskparams = val
        print(f'root ${root}, points {points}, maskparams {maskparams}, w {w}, h {h}')
...
def howToUse(main, color):
    ...
    # creates github btn
    img = Image.open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/github.png")
    ...
    # creates site btn
    img2 = Image.open("/Users/shivanshshukla/Downloads/lightscreen-touchscreen-detection/data/src/lightscreen.png")
    resized = img2.resize((256, 256), Image.Resampling.LANCZOS)
